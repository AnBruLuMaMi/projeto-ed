package projetoed.estruturas.mapaordenado.test;
...
public class MapaOrdenadoABBTest {
    @Test
    void test() {
        MapaOrdenado<Integer, Integer> A = new MapaOrdenado<>();
        ...
        System.out.println(A.root().element().getKey());
    }
}
